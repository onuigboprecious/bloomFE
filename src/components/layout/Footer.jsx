        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <a
              ...
              className="w-8.5 h-8.5 rounded-xl bg-emerald-600/20 hover:bg-emerald-500 border border-emerald-500/40 hover:border-emerald-400 flex items-center justify-center text-emerald-400 hover:text-white transition-all transform hover:-translate-y-0.5 shadow-sm group"
            >
              <svg className="w-3.5 h-3.5 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
