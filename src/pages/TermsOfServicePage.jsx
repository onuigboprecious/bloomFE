        ...
        <div className="space-y-8 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
          <section className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-slate-200/80 dark:border-slate-800 space-y-3">
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-600 dark:text-slate-300 text-xs sm:text-sm leading-relaxed">
                Purchased Enlazer NFC Cards are single-time hardware transactions (₦19,000 for standard finishes). You retain full lifetime ownership of your physical card. Your digital profile remains free forever, with optional pro tier handle & analytics upgrades available.
              </p>
            </div>
            ...
            <div className="space-y-2">
              <h3 className="text-[#00BCFF] font-extrabold text-sm uppercase tracking-wider">4. Subscriptions & Billing</h3>
              <p className="text-slate-600 dark:text-slate-300 text-xs sm:text-sm leading-relaxed">
                Optional Enlazer Pro features (₦3,500/mo or ₦35,000/yr) can be canceled at any time from your Billing tab without losing basic contact card functionality.
              </p>
            </div>
          </section>
        </div>
