...
export const HeroShowcase = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      desc: "Pay ₦35,000 only when ready to go live. Your profile goes public instantly and your custom NFC smart card or wristband is shipped free to your door."
    }
  ];
          ...
          {steps.map((s, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 sm:p-8 relative flex flex-col justify-between transition-all group"
              >
