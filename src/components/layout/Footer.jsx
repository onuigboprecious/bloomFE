      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 pb-12 border-b border-slate-800">
            ...
            <div className="pt-3">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a
                  ...
                  aria-label="TikTok"
                  className="w-9 h-9 rounded-xl bg-slate-800 hover:bg-black border border-slate-700 hover:border-cyan-400/50 flex items-center justify-center text-slate-300 hover:text-white transition-all transform hover:-translate-y-0.5 shadow-sm group"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                  className="w-9 h-9 rounded-xl bg-slate-800 hover:bg-[#1877F2] border border-slate-700 hover:border-[#1877F2]/50 flex items-center justify-center text-slate-300 hover:text-white transition-all transform hover:-translate-y-0.5 shadow-sm group"
                >
                  <svg className="w-4 h-4 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-slate-800 hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] border border-slate-700 hover:border-pink-500/50 flex items-center justify-center text-slate-300 hover:text-white transition-all transform hover:-translate-y-0.5 shadow-sm group"
                >
                  <svg className="w-4 h-4 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-slate-800 hover:bg-slate-950 border border-slate-700 hover:border-cyan-400/50 flex items-center justify-center text-slate-300 hover:text-white transition-all transform hover:-translate-y-0.5 shadow-sm group"
                >
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-emerald-600/20 hover:bg-emerald-500 border border-emerald-500/40 hover:border-emerald-400 flex items-center justify-center text-emerald-400 hover:text-white transition-all transform hover:-translate-y-0.5 shadow-sm group"
                >
                  <svg className="w-4 h-4 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              ...
              <li className="flex items-center gap-2 text-xs pt-1">
                <MessageSquare className="w-4 h-4 text-emerald-400 shrink-0" />
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:text-emerald-300 font-semibold transition-colors flex items-center gap-1">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-4 text-slate-400">
            <a href="https://tiktok.com/@enlazer_cloud" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors">TikTok</a>
            <span>•</span>
            <a href="https://facebook.com/enlazer" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors">Facebook</a>
            <span>•</span>
            <a href="https://instagram.com/enlazer_cloud" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors">Instagram</a>
            <span>•</span>
            <a href="https://x.com/enlazer_cloud" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors">X (Twitter)</a>
          </div>
        </div>
      </div>
    </footer>
