    ...
    <div className="space-y-6 pt-1">
      ...
      <div className="p-5 rounded-2xl bg-[var(--card)] border border-[var(--border)] space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[11px] text-[var(--text-dim)]">PNG, JPG or WEBP (Max 5MB)</span>
        </div>
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="flex-1 space-y-2">
            <p className="text-xs text-[var(--text-dim)] leading-relaxed font-normal">
      ...
      <div className="space-y-1.5">
        <label className="text-xs font-bold uppercase tracking-wider text-[var(--text)] flex items-center gap-1.5">
          <User className="w-3.5 h-3.5 text-[var(--accent)]" /> Full Display Name
        </label>
        <input
          type="text"
          value={name}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-1.5">
          <label className="text-xs font-bold uppercase tracking-wider text-[var(--text)] flex items-center gap-1.5">
            <Briefcase className="w-3.5 h-3.5 text-[var(--accent)]" /> Job Title / Craft
          </label>
          <input
            type="text"
            value={title}
        ...
        <div className="space-y-1.5">
          <label className="text-xs font-bold uppercase tracking-wider text-[var(--text)] flex items-center gap-1.5">
            <Building className="w-3.5 h-3.5 text-[var(--accent)]" /> Company / Studio
          </label>
          <input
            type="text"
            value={company}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-1.5">
          <label className="text-xs font-bold uppercase tracking-wider text-[var(--text)] flex items-center gap-1.5">
            <Phone className="w-3.5 h-3.5 text-[var(--success)]" /> Direct Phone Number
          </label>
          <input
            type="tel"
            value={phone}
        ...
        <div className="space-y-1.5">
          <label className="text-xs font-bold uppercase tracking-wider text-[var(--text)] flex items-center gap-1.5">
            <MapPin className="w-3.5 h-3.5 text-[var(--success)]" /> Base Location
          </label>
          <input
            type="text"
            value={location}
      ...
      <div className="flex items-center justify-between p-4 rounded-xl bg-[var(--card)] border border-[var(--border)]">
        <div className="space-y-0.5 min-w-0 pr-3">
          <span className="text-xs font-bold text-[var(--text)] flex items-center gap-1.5">
            <Mail className="w-3.5 h-3.5 text-[var(--accent)]" /> Public Email Visibility
          </span>
        ...
        <button
          ...
          className={`w-12 h-6 flex items-center rounded-full p-1 cursor-pointer transition-colors shrink-0 ${showEmail ? 'bg-[var(--accent)]' : 'bg-[var(--input-bg)] border border-[var(--border)]'}`}
        >
      ...
      <div className="space-y-1.5">
        <label className="text-xs font-bold uppercase tracking-wider text-[var(--text)] flex items-center gap-1.5">
          <FileText className="w-3.5 h-3.5 text-[var(--accent)]" /> Bio / Pitch Summary
        </label>
        <textarea
          rows={3}
          value={bio}
          ...
          className="w-full bg-[var(--input-bg)] border border-[var(--border)] text-[var(--text)] rounded-xl p-3.5 text-xs font-normal focus:outline-none focus:border-[var(--accent)] leading-relaxed"
        />
      </div>
    </div>
  );
