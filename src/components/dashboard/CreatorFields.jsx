    ...
    <div className="p-5 rounded-2xl bg-[#00BCFF]/5 border border-[#00BCFF]/20 space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div>
          ...
          <input
            type="text"
            value={track.title || ''}
            onChange={(e) => setFeaturedTrack({ ...track, title: e.target.value })}
        ...
        <div>
          ...
          <input
            type="text"
            value={track.artist || ''}
            onChange={(e) => setFeaturedTrack({ ...track, artist: e.target.value })}
      ...
      <div>
        ...
        <input
          type="text"
          value={track.cover || ''}
          onChange={(e) => setFeaturedTrack({ ...track, cover: e.target.value })}
          placeholder="https://..."
          className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white rounded-xl px-3.5 py-2 text-xs font-bold focus:outline-none focus:border-[#00BCFF]"
        />
      </div>
